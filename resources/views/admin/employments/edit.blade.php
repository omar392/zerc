            ...
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="" id="employments" method="POST" data-parsley-validate>
                                @csrf
                                @method('put')
                                <input type="hidden" name="employmentId" id="employment_id" value="{{$employment->id}}" class="form-control">
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">{{ __('admin.title_ar') }}</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $employment->title_ar }}" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $employment->title_en }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $employment->url }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="description_ar" id="editor3" cols="10" rows="10">{!! $employment->description_ar !!}</textarea>
                                     <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control"  name="description_en" id="editor4" cols="10" rows="10">{!! $employment->description_en !!}</textarea>
                                     <script>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" name="image" id="image" value="{{$employment->image}}"  class="filestyle image" data-buttonname="btn-primary" >
                                        <img src="{{ asset('/dashboard/employments/' . $employment->image) }}"
...
<script>
    $(function () {
        ...
        let url = $("input[name=url]").val();
            ...
            $('body').on('submit','#employments',function (e) {
                e.preventDefault();
                //  alert('no problem');
                 let id = $('#employment_id').val();
                 var url = '{{ route('employments.update', ':id') }}';
