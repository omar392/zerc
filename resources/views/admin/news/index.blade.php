    ...
    <div class="content">
        <div class="page-title-box">
            ...
            <div class="row align-items-center">
                ...
                <div class="text-center">
                    ...
                    @if (Auth::guard('admin')->user()->hasPermission('news-create'))
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                            data-target="#modal-add-new" style="margin-right: 20px;margin-left: 20px;"><i
                ...
                <div class="modal fade modal-add-new" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                    aria-hidden="true" id="modal-add-new">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="modal-add-new">
                                <div class="modal-body">
                                    <div class="card-body">
                                        <form id="addnew" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                            @csrf
                                            @method('post')
