        ...
        <div class="page-title-box">
            ...
            <div class="row align-items-center">
                ...
                <div class="text-center">
                    <!-- Large modal -->
                    @if (Auth::guard('admin')->user()->hasPermission('locations-create'))
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                            data-target="#modal-add-location" style="margin-right: 20px;margin-left: 20px;"><i
                                class="fas fa-plus-circle" style="padding-inline-end: 5px;"></i>{{ __('admin.add') }}
                            {{ __('admin.location') }}</button>
                    @endif
                    <button type="button" class="btn btn-primary reload float-right mb-3"> <i class="fas fa-sync-alt"></i></button>
                </div>

                <!--  Modal content for the above example -->
                <div class="modal fade modal-add-location" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                    aria-hidden="true" id="modal-add-location">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title mt-0" id="myLargeModalLabel">{{ __('admin.add') }}
                                    {{ __('admin.location') }}</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                                    data-target="#modal-add-location">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>

                            <div class="modal-body" id="modal-add-location">
                                <div class="modal-body">
                                    <div class="card-body">
                                        <form id="addlocation" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                            @csrf
                                            @method('post')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input id ="alert" class="form-control .inp1" value="{{ old('0') }}" type="text"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control .inp2" value="{{ old('1') }}"
                                                           name="1" id="example-text-input"
                                                           placeholder="{{ __('admin.lang') }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                 <textarea class="form-control .inp3"  name="2" id="" cols="10" rows="10"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input"
                                                ...
                                                <div class="col-sm-10">
                                                 <textarea class="form-control .inp4"  name="3" id="" cols="10" rows="10"></textarea>
                                                </div>
                                            </div>
...
@push('js')
    ...
    <script>
        ...
        $('body').on('submit', '#addlocation', function(e) {
            e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status == 'success') {
                            ...
                            $('#modal-add-location .close').click();
