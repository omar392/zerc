                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="" id="faqs" method="POST" data-parsley-validate>
                                @csrf
                                @method('put')
                                <input type="hidden" name="faqId" id="faq_id" value="{{$faq->id}}" class="form-control">
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">{{ __('admin.ask_ar') }}</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $faq->ask_ar }}" type="text"
                                            name="ask_ar" id="example-text-input"
                                            placeholder="{{ __('admin.ask_ar') }} " required parsley-trigger="change" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $faq->ask_en }}"
                                            name="ask_en" id="example-text-input"
                                            placeholder="{{ __('admin.ask_en') }}" required parsley-trigger="change" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control .inp3"  name="answer_ar" id="" cols="10" rows="10">{!! $faq->answer_ar !!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
                                    ...
                                    <div class="col-sm-10">
                                     <textarea class="form-control .inp4"  name="answer_en" id="" cols="10" rows="10">{!! $faq->answer_en !!}</textarea>
                                    </div>
                                </div>
